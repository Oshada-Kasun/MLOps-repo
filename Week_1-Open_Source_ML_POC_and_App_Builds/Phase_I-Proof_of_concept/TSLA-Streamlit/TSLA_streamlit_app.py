...
# Config for page
st.set_page_config(
    page_title= "Oshada TSLA Bot",### YOUR LINE OF CODE HERE
    page_icon='✅',
    layout='wide',
)
...
with st.sidebar:
    ...
    start_date_filter = st.date_input(
        'Start Date',### YOUR LINE OF CODE HERE
...
tsla_logo = Image.open('./images/Oshada.png')### YOUR LINE OF CODE HERE
reddit_logo = Image.open('./images/reddit_logo.png')
st.image([tsla_logo, reddit_logo], width=200)

# dashboard title
st.title('TSLA Subreddit and Stock Price')### YOUR LINE OF CODE HERE
...
for i in range(1, len(dfSentiment)-1):
    ...
    with placeholder.container():
        ...
        kpi2.metric(
            ...
            value=round(last_close),### YOUR LINE 1 OF CODE HERE
            delta=round(last_close - last_close_lag1)### YOUR LINE 2 OF CODE HERE
        )
        ...
        with fig_col1:
            ...
            if sentiment_select.startswith('perc') == True:
                yaxis_label = '% Change Sentiment'### YOUR LINE OF CODE HERE

            elif sentiment_select in sentiment_cols:
                yaxis_label = 'Sentiment'### YOUR LINE OF CODE HERE
            ...
            st.write(fig)### YOUR LINE OF CODE HERE
